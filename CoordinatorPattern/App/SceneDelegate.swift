...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private lazy var coordinator: Coordinatable = makeAppCoordinator()
...
private extension SceneDelegate {
    func makeAppCoordinator() -> Coordinatable {
        guard let rootNav = window?.rootViewController as? UINavigationController else {
            fatalError("RootViewController must be a UINavigationController")
        }
        
        let router = Router(rootController: rootNav)
